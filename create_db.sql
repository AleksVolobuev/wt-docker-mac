...
CREATE DATABASE [WTDB] 
 ON  PRIMARY 
( NAME = N'WTDB', FILENAME = N'/mssql/WTDB.mdf' , SIZE = 51200KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%), 
 FILEGROUP [BLOBS] 
( NAME = N'BLOBS', FILENAME = N'/mssql/WTDB_blobs.mdf' , SIZE = 51200KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%), 
 FILEGROUP [FT_IDX] 
( NAME = N'FT_IDX', FILENAME = N'/mssql/WTDB_ft_idx.mdf' , SIZE = 51200KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%), 
 FILEGROUP [IDX] 
( NAME = N'IDX', FILENAME = N'/mssql/WTDB_idx.mdf' , SIZE = 51200KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
 LOG ON 
( NAME = N'LOG', FILENAME = N'/mssql/T1_WTDB.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
